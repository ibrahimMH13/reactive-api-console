            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg border border-slate-700 p-6 mb-6">
              <div className="flex items-center space-x-4">
                <div className="flex-1">
                  <input
                    type="text"
                    placeholder="Type a command... (e.g., 'get weather Berlin', 'search github john')"
                ...
                <button className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors">
          ...
          <div className="lg:col-span-1">
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg border border-slate-700 p-6 h-full">
              ...
              <div className="space-y-3">
                {['Weather', 'Cat Facts', 'GitHub', 'Chuck Norris', 'Bored API', 'Custom Backend'].map((api) => (
                  <div key={api} className="flex items-center justify-between p-3 bg-slate-700/30 rounded-lg">
